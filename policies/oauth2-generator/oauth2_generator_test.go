...
func TestOnUpstreamAttemptRequest_AttemptOneUsesCachedToken(t *testing.T) {
...
func TestOnUpstreamAttemptRequest_RetryPurgesAndRefetches(t *testing.T) {
	...
	_ = p.OnUpstreamAttemptRequest(context.Background(), actx)
...
func TestOnUpstreamAttemptRequest_FetchErrorFailsOpen(t *testing.T) {
