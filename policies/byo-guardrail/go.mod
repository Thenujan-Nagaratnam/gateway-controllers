...
// model-failover/go.mod and guardrails-ai/go.mod for the same situation). Points sideways
// to the sibling api-platform checkout on this machine, not a subdirectory of this repo.
// Remove this replace once a tagged sdk/core release carrying SharedHTTPClient is
// available and this module's require above is bumped to it.
